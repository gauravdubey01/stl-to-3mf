...
## Session: v2.5 Update (July 7, 2026)

### Changes Made
- Added Ko-fi donation link in bottom footer with embedded logo
- Added tutorial dialog on first open
- Added close confirmation dialog with support message
- Added "made by Gaurav Dubey" credit in footer
- Theme toggle now shows "Dark"/"Light" text
- Version bumped from 2.3.0.0 to 2.5.0.0
- Updated window title and header label to v2.5
- Updated AppxManifest.xml, BuildMsix.cs, build-msix.ps1 versions
- Recompiled StlTo3mfConverter.exe
- Rebuilt MSIX packages as StlTo3mfConverter-2.5.0.0

### Files
| File | Status |
|---|---|
| `StlTo3mfConverter.cs` | Updated (v2.5) |
| `AppxManifest.xml` | Version 2.5.0.0 |
| `BuildMsix.cs` | Version 2.5.0.0 |
| `build-msix.ps1` | Version 2.5.0.0 |
| `StlTo3mfConverter.exe` | Recompiled |
| `StlTo3mfConverter-2.5.0.0.msix` | Rebuilt |
| `StlTo3mfConverter-2.5.0.0.msixupload` | Rebuilt |
- Folder `microsoft upload files 2\` contains updated Store upload files
